...
// Mod Tap Definitions
#define SYM_SPC	MT(MOD_MO(SYM), KC_SPC)
#define NAV_T	MT(MOD_MO(NAV), KC_T)
#define NAV_N	MT(MOD_MO(NAV), KC_N)
#define NUM_D	MT(MOD_MO(NUM), KC_D)
#define NUM_H	MT(MOD_MO(NUM), KC_H)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [BASE] = LAYOUT_ortho_4x12( \
     ...
     KC_NO, KC_GAME, KC_NO, KC_OS, LCTL_T(KC_BSPC), SYM_SPC,		SFT_T(KC_BSPC), ALT_T(KC_E), KC_OS, KC_NO,  KC_NO, KC_NO \
  ),
  ...
  [NUM] = LAYOUT_ortho_4x12( \
    ...
    KC_NO, KC_NO, KC_NO,  KC_OS,  KC_LCTRL, KC_NO,		KC_LSFT, KC_LALT, KC_OS, KC_NO, KC_NO,  KC_NO \
  ),
  ...
  [SYM] = LAYOUT_ortho_4x12( \
     ...
     KC_NO, KC_NO, KC_NO,   KC_OS,   KC_NO,   KC_NO,		KC_LSFT, KC_RALT, KC_NO, KC_NO, KC_NO, KC_NO \
  ), 
